...
<body class="bg-gray-100">
    <header class="p-5 border-b bg-white shadow">
       <div class="container text-center flex flex-col gap-3 md:flex-row md:justify-between md:mx-auto items-center">
            ...
            {{--Autenticado--}}
        @auth
            <nav class="flex flex-col items-center gap-3 md:flex-row">
